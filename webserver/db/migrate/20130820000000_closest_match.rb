class ClosestMatch < ActiveRecord::Migration
  def self.up
    unless table_exists? "processed_spectrums"
      create_table "processed_spectrums" do |t|
        t.integer   :spectrum_id
        
        # This looks strange, but works well
        t.integer	  :a10, :default => 0 # Each column for matching. Looks weird, haha
  ...
  def self.down
    drop_table "processed_spectrums"
  end
end
